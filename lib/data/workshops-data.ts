...
const workshops: Workshop[] = [
  ...
  },
  {
    ...
    contact: "Contact BJAS",
    email: "admissions@bjas.in",
    eligibility: "Professional actors / BJAS alumni",
    venue: "Mumbai",
    category: "Acting & Performance",
  ...
  {
    id: 28,
    title: "Weekend Theatre Course (Delhi)",
    trainer: "BJAS Faculty",
    institution: "Barry John Acting Studio",
    location: "Delhi",
    state: "Delhi",
    ...
    venue: "Delhi",
    category: "Acting & Performance",
    tags: ["Weekend Course", "Beginner-friendly"],
    mode: "In-person",
    expiresOn: "2026-11-08",
  },
  {
    id: 29,
    title: "Weekend Theatre Course (Mumbai)",
    trainer: "BJAS Faculty",
    institution: "Barry John Acting Studio",
    location: "Mumbai",
    state: "Maharashtra",
    country: "India",
    date: "25 Jul 2026 onwards",
  ...
  },
  {
    ...
    contact: "Contact Five Senses Theatre",
    email: "info@fivesensestheatre.com",
    eligibility: "Intermediate to advanced",
    venue: "Andheri West, Mumbai",
    category: "Acting & Performance",
    tags: ["Advanced", "Camera Work"],
    mode: "In-person",
  ...
  },
  {
    ...
    contact: "Contact via form",
    email: "voicework.vachika@gmail.com",
    eligibility: "Professional and pre-professional performers",
    venue: "Andheri West, Mumbai",
    category: "Voice & Speech",
    tags: ["Voice Training", "Intensive"],
    mode: "In-person",
  ...
  },
  {
    ...
    contact: "Contact NIPAI",
    email: "info@nipai.org",
    eligibility: "Professional and pre-professional performers, directors",
    venue: "Berlin",
    category: "Movement & Physical Theatre",
    tags: ["International", "Physical Theatre", "Selective"],
    mode: "In-person",
  ...
  },
  {
    ...
    price: "Not published — contact for details",
    contact: "020-25580085",
    email: "info@ftii.ac.in",
    eligibility: "Film enthusiasts, practitioners",
    venue: "New Mumbai",
  ...
  },
  {
    ...
    contact: "020-25580085",
    email: "info@ftii.ac.in",
    eligibility: "Writers, filmmakers, creative professionals",
    venue: "Online",
