...
const workshops: Workshop[] = [
  ...
  // INTERNATIONAL — Movement, Physical Theatre, Clown & Mask
  {
    ...
    fullDetails: {
      description:
        "Summer Stage 2026 at Teatracció Physical Theatre School offers a modular journey through Jacques Lecoq's pedagogy in beautiful Barcelona. Participants can choose from modules covering Neutral Mask, Expressive/Larval Masks, Clown, and Theatre of Objects. Each module explores stage presence, movement, and comedy through the renowned Lecoq approach that has influenced physical theatre worldwide.",
      keyHighlights: [
        "Jacques Lecoq pedagogy",
        "Modular format (5 days each)",
        "Neutral Mask exploration",
        "Expressive/Larval Masks work",
        "Clown training",
        "Theatre of Objects",
      ...
      curriculum: [
        "Neutral Mask fundamentals",
        "Expressive Mask techniques",
        "Larval Mask exploration",
        "Clown and comedy work",
        "Theatre of Objects creation",
        "Movement analysis",
        "Stage presence and presence exercises",
        "Ensemble physical work",
      ],
      duration: "5 days per module (20 hours each)",
      medium: "English/Spanish",
      courseFee: "€250 per module",
      certification: "Teatracció Summer Stage Certificate",
      contactInfo: ["Website: https://www.teatraccio.es/en/summer-stage/", "Email: info@teatraccio.es"],
      venue: "Teatracció Physical Theatre School, Barcelona, Spain",
      organizer: "Teatracció Physical Theatre School",
    },
  },
  {
    id: 73,
    ...
    fullDetails: {
      description:
        "The MAKE Residency at Gecko Theatre offers a unique opportunity to work directly with Artistic Director Amit Lahav on devising physical theatre. This week-long residential program focuses on ensemble physical theatre methods developed by Gecko over their acclaimed career. Bursary places are available to support underrepresented artists.",
      keyHighlights: [
        "Direct training with Amit Lahav",
        "Gecko's ensemble physical theatre methods",
        "1-week residential program",
        "Devising-focused curriculum",
        "Bursary places for underrepresented artists",
        "Mid- & early-career practitioners",
        "Professional development focus",
        "Gecko Theatre legacy training",
      ],
      curriculum: [
        "Gecko's physical theatre methodology",
        "Ensemble devising techniques",
        "Movement vocabulary development",
        "Collaborative creation processes",
        "Visual storytelling",
        "Physical narrative construction",
        "Director-performer collaboration",
        "Work-in-progress sharing",
      ],
      duration: "1 week, residential",
      medium: "English",
      courseFee: "Contact Gecko Theatre (Bursaries available)",
      certification: "Gecko MAKE Residency Completion",
      contactInfo: ["Website: https://www.geckotheatre.com/residencies-make", "Email: info@geckotheatre.com"],
      venue: "Gecko Theatre, Ipswich, Suffolk, UK",
      organizer: "Gecko Theatre",
    },
  },
  {
    id: 74,
    ...
    fullDetails: {
      description:
        "The NIPAI Physical Theatre Intensive is an immersive 3-week intercultural residency in Csurgó, Hungary. The program integrates Meyerhold biomechanics, Stanislavski physical action, and Chekhov psychological gesture, culminating in a community sharing. This intensive welcomes dancers, actors, directors, mimes, musical theatre artists, and interdisciplinary performers.",
      keyHighlights: [
        "3-week residential intensive",
        "Meyerhold biomechanics training",
        "Stanislavski physical action",
        "Chekhov psychological gesture",
        "Intercultural ensemble work",
        "Community sharing finale",
        "Interdisciplinary approach",
        "International participant cohort",
      ],
      curriculum: [
        "Meyerhold biomechanics fundamentals",
        "Stanislavski's Method of Physical Actions",
        "Michael Chekhov's psychological gesture",
        "Cross-cultural performance traditions",
        "Ensemble creation processes",
        "Physical dramaturgy",
      ...
      medium: "English",
      courseFee: "Contact NIPAI for fee details",
      certification: "NIPAI Physical Theatre Intensive Certificate",
      contactInfo: ["Website: https://www.nipai.org/programs/intensive", "Email: info@nipai.org"],
      venue: "NIPAI, Csurgó, Somogy, Hungary",
      organizer: "New International Performing Arts Institute (NIPAI)",
    },
  },
  // INTERNATIONAL — Direction, Dramaturgy & Devising
  {
    ...
    fullDetails: {
      description:
        "The Theatertreffen International Forum 2026 is a prestigious 2.5-week program for emerging performing arts practitioners from around the world. Hosted at the unique Floating University in Berlin, participants engage in workshops, jury exchanges, and gain access to the renowned Theatertreffen festival. This scholarship/grant opportunity focuses on direction, dramaturgy, design, and applied/social-political theatre practice.",
      keyHighlights: [
        "Prestigious international forum",
        "2.5 weeks at Floating University Berlin",
        "Workshops with international artists",
        "Jury exchanges and discussions",
        "Full Theatertreffen festival access",
        "Worldwide open call",
        "Scholarship/grant funded",
        "Focus on emerging practitioners",
      ],
      curriculum: [
        "Contemporary theatre practice workshops",
        "Directorial approaches",
        "Dramaturgical methodologies",
        "Design and scenography sessions",
        "Applied theatre practice",
        "Social-political theatre discourse",
        "Jury exchange participation",
        "Festival analysis and discussion",
      ],
      duration: "2.5 weeks (May 1 – 17, 2026)",
      medium: "German/English",
      courseFee: "Scholarship / Grant (funded)",
      certification: "Theatertreffen International Forum Participation",
      contactInfo: ["Website: https://www.berlinerfestspiele.de/", "Email: theatertreffen@berlinerfestspiele.de"],
      venue: "Floating University, Berlin, Germany",
      organizer: "Berliner Festspiele (Theatertreffen)",
    },
  },
  {
    id: 76,
    ...
    fullDetails: {
      description:
        "The International Workshop Mülheim 2026 is a funded translation workshop for translators of German-language drama, held in the framework of the prestigious Mülheimer Theatertage festival. Supported by Goethe-Institut, this approximately 2-week program provides translators with direct exposure to contemporary German playwriting and theatre practice.",
      keyHighlights: [
        "Funded translation workshop",
        "Mülheimer Theatertage framework",
        "Goethe-Institut support",
        "~2 week program",
        "German-language drama focus",
        "Direct festival integration",
        "International translator cohort",
        "Application deadline: Feb 15, 2026",
      ],
      curriculum: [
        "German drama translation workshop",
      ...
      duration: "~2 weeks (May 22 – June 6, 2026)",
      medium: "German/English",
      courseFee: "Funded (Scholarship / Grant)",
      certification: "ITI International Workshop Certificate",
      contactInfo: ["Website: https://www.iti-worldwide.org/", "Email: info@iti-germany.de"],
      venue: "Mülheim, North Rhine-Westphalia, Germany",
      organizer: "German Centre of ITI + Mülheimer Theatertage + Goethe-Institut",
    },
  },
  {
    id: 77,
    ...
    fullDetails: {
      description:
        "The OYL International Performance Residency 2026 is a transformative multi-country residency centered on dreams and mythology. Participants travel to India (June 14–27), Japan (June 28–July 11), and Greece (July 13–August 10), engaging with Janapada/Yakshagana, Noh, Kabuki, and the Greek myth of Orpheus. All in-country costs are covered by One Year Lease.",
      keyHighlights: [
        "Multi-country residency (India, Japan, Greece)",
        "8 weeks total possible",
        "Dreams & mythology theme",
        "Janapada/Yakshagana training (India)",
        "Noh and Kabuki exposure (Japan)",
        "Greek myth of Orpheus (Greece)",
        "All in-country costs covered",
        "Rolling applications until March 16, 2026",
      ],
      curriculum: [
        "Janapada folk performance (India)",
        "Yakshagana dance-drama (India)",
        "Noh theatre principles (Japan)",
        "Kabuki aesthetics (Japan)",
        "Greek tragedy and myth (Greece)",
        "Orpheus narrative exploration",
        "Cross-cultural ensemble creation",
        "Final performance sharing",
      ],
      duration: "2–4 weeks per country (8 weeks total: June 14 – August 10, 2026)",
      medium: "English (with local language exposure)",
      courseFee: "All in-country costs covered by OYL",
      certification: "OYL International Residency Certificate",
      contactInfo: ["Website: https://www.oneyearlease.org/international-residency", "Email: info@oneyearlease.org"],
      venue: "Bengaluru (India), Tokyo (Japan), Ioannina/Athens (Greece)",
      organizer: "One Year Lease (OYL)",
    },
  },
  // INTERNATIONAL — Design, Production & Stage Management
  {
    ...
    fullDetails: {
      description:
        "The MPulse Theatre Design & Production Workshop at University of Michigan offers a comprehensive 2-week residential program covering all aspects of theatrical design and production. Students explore scenic painting, costume design, lighting, sound, props, and projections, creating portfolio-ready work. Fee waivers are available for qualifying students.",
      keyHighlights: [
      ...
      duration: "2 weeks (June 21 – July 4, 2026)",
      medium: "English",
      courseFee: "Contact SMTD (Fee waivers available)",
      certification: "MPulse Theatre Design & Production Certificate",
      contactInfo: ["Website: https://smtd.umich.edu/engagement-outreach/youth-programs/mpulse/design-production-workshop/", "Email: smtd.mpulse@umich.edu"],
      venue: "University of Michigan, Ann Arbor, Michigan, USA",
      organizer: "University of Michigan School of Music, Theatre & Dance",
    },
  },
  {
    id: 79,
    ...
    fullDetails: {
      description:
        "The Stage Lighting Short Course at Guildhall School of Music & Drama provides a hands-on introduction to theatrical lighting. Over 5 days, participants learn about lanterns, lenses, rigging, focus, plan reading, and the practical experience of lighting a small show. Ideal for ages 16+ interested in technical theatre.",
      keyHighlights: [
        "5-day intensive course",
        "Hands-on lighting introduction",
        "Lanterns and lenses training",
      ...
      curriculum: [
        ...
        "Lantern types and uses",
        "Lens properties and effects",
        "Safe rigging practices",
        "Focusing techniques",
        "Lighting plan interpretation",
        "Color and gel selection",
        "Practical show lighting",
      ],
      duration: "5 days",
      medium: "English",
      courseFee: "Contact Guildhall for fee details",
      certification: "Guildhall Short Course Certificate",
      contactInfo: ["Website: https://www.gsmd.ac.uk/", "Email: shortcourses@gsmd.ac.uk"],
      venue: "Guildhall School of Music & Drama, London, UK",
      organizer: "Guildhall School of Music & Drama",
    },
  },
  {
    id: 80,
    ...
    fullDetails: {
      description:
        "Interlochen Arts Camp's Theatre Design & Production program offers two distinct 3-week sessions for high school students. Session 1 focuses on design (lighting, costume, set), while Session 2 provides hands-on tech theatre experience including Tech Olympics and backstage skills development.",
      keyHighlights: [
        "Two 3-week session options",
        "Session 1: Design focus",
        "Session 2: Tech theatre focus",
        "Lighting design training",
        "Costume design workshop",
        "Set design fundamentals",
        "Tech Olympics competition",
        "Backstage skills development",
      ],
      curriculum: [
        "Lighting design (Session 1)",
        "Costume design (Session 1)",
        "Set design (Session 1)",
        "Tech Olympics challenges (Session 2)",
        "Backstage management (Session 2)",
        "Running crew experience",
        "Production collaboration",
        "Portfolio development",
      ],
      duration: "3 weeks each session (June – July 2026)",
      medium: "English",
      courseFee: "Contact Interlochen for fee details",
      certification: "Interlochen Arts Camp Certificate",
      contactInfo: ["Website: https://www.interlochen.org/theatre/camp-programs/high-school/theatre-design-production", "Email: admissions@interlochen.org"],
      venue: "Interlochen Arts Camp, Interlochen, Michigan, USA",
      organizer: "Interlochen Arts Camp",
    },
  },
  // INTERNATIONAL — Residencies & Research-Based Opportunities
  {
    ...
    fullDetails: {
      description:
        "Island Connect II is an EU Creative Europe-funded program offering split residencies across European island regions. With three open calls per year, artists and companies engaged with themes of insularity and island identity can access residencies in locations including Corsica, Croatia, Tenerife, Ireland, Sweden, Finland, Mallorca, Sardinia, Norway, Madeira, and Martinique.",
      keyHighlights: [
        "EU Creative Europe funded",
        "Split residencies across islands",
        "Three open calls per year",
        "2 weeks to 1 month duration",
        "Work-in-progress sharings",
        "Festival presentation opportunities",
        "Insularity/island identity themes",
        "Multiple European locations",
      ],
      curriculum: [
        "Site-specific creation",
        "Island identity exploration",
        "Cross-cultural collaboration",
        "Work-in-progress development",
        "Community engagement",
        "Festival presentation",
        "Networking with island artists",
        "Documentation and sharing",
      ],
      duration: "2 weeks – 1 month (various calls April – September 2026)",
      medium: "Various languages",
      courseFee: "Funded Residency",
      certification: "Island Connect Residency Completion",
      contactInfo: ["Website: https://islandconnect.eu/", "Email: info@islandconnect.eu"],
      venue: "Corsica, Croatia, Tenerife, Ireland, Sweden, Finland, Mallorca, Sardinia, Norway, Madeira, Martinique",
      organizer: "Island Connect (EU Creative Europe)",
    },
  },
  {
    id: 82,
    ...
    fullDetails: {
      description:
        "Theatre No Theatre offers a specialized 5-day residency continuing the Workcenter legacy of Thomas Richards and Jerzy Grotowski. Focused on songs of tradition and embodied performance research, this residency is open to artists who have participated in 'Il canto vivo' workshops in Milan since 2022.",
      keyHighlights: [
        "Workcenter legacy continuation",
        "Thomas Richards lineage",
        "Songs of tradition focus",
        "Embodied performance research",
        "5-day intensive residency",
        "Ameno & Milan locations",
        "Advanced practitioners only",
        "'Il canto vivo' alumni",
      ],
      curriculum: [
        "Songs of tradition practice",
        "Embodied performance research",
        "Workcenter methodology",
      ...
      duration: "5 days (June 19 – 23, 2026)",
      medium: "Italian/English",
      courseFee: "Contact Theatre No Theatre",
      certification: "Theatre No Theatre Residency Participation",
      contactInfo: ["Website: https://www.theatrenotheatre.com", "Email: info@theatrenotheatre.com"],
      venue: "Ameno & Milan, Italy",
      organizer: "Theatre No Theatre",
    },
  },
  {
    id: 83,
    ...
    fullDetails: {
      description:
        "The Mediterranean Dance Center (MPC) Artistic Residencies in Svetvinčenat, Croatia offer movement-based artists 2-week residencies with community engagement requirements. Artists must deliver a talk, workshop, and work-in-progress sharing, culminating in a final work sharing at the end of the residency period.",
      keyHighlights: [
        "2-week artist residency",
        "Movement-based focus",
        "Funded residency opportunity",
        "Community engagement required",
        "Artist talk component",
        "Workshop delivery",
        "Work-in-progress sharing",
        "Beautiful Istria location",
      ],
      curriculum: [
        "Independent artistic research",
        "Community talk preparation",
      ...
      duration: "2 weeks (May 3 – 16, 2026)",
      medium: "English/Croatian",
      courseFee: "Funded Residency",
      certification: "MPC Artistic Residency Completion",
      contactInfo: ["Website: https://www.mediteranskiplesnicentar.hr/en/artistic-residencies-in-2026-open-call.html", "Email: info@mediteranskiplesnicentar.hr"],
      venue: "Svetvinčenat, Istria, Croatia",
      organizer: "Mediteranski plesni centar (Mediterranean Dance Center)",
    },
  },
  {
    id: 84,
    ...
    fullDetails: {
      description:
        "The Grotowski Institute offers research-based residencies and traineeships at its legendary facilities in Wrocław and Brzezinka, Poland. Continuing the legacy of Jerzy Grotowski's groundbreaking theatre laboratory work, the Institute provides opportunities for individual artists, postgraduate researchers, and theatre practitioners to engage deeply with performance research.",
      keyHighlights: [
        "Jerzy Grotowski legacy",
        "Research-based residencies",
        "Traineeships available",
        "Year-round opportunities",
        "Rolling applications",
        "Wrocław & Brzezinka locations",
        "Project-based duration",
        "International artists welcome",
      ],
      curriculum: [
        "Grotowski methodology research",
        "Performance as research",
        "Physical training traditions",
        "Vocal and song work",
        "Laboratory theatre practice",
        "Archival research access",
        "Mentorship with faculty",
        "Public presentation",
      ],
      duration: "Variable (project-based, year-round)",
      medium: "Polish/English",
      courseFee: "Contact Grotowski Institute",
      certification: "Grotowski Institute Residency/Traineeship Certificate",
      contactInfo: ["Website: https://grotowski-institute.art.pl/", "Email: instytut@grotowski-institute.art.pl"],
      venue: "Grotowski Institute, Wrocław & Brzezinka, Lower Silesia, Poland",
      organizer: "Grotowski Institute",
    },
  },
  {
    id: 85,
    ...
    fullDetails: {
      description:
        "The 2026 Flaherty Fellowship provides an immersive 3-day experience for emerging filmmakers and media artists from around the world. Organized by the prestigious Flaherty Film Seminar, this fellowship brings together 15 in-person and 15 online fellows for intensive engagement with cutting-edge documentary and experimental cinema. The program features world premieres, retrospectives, artist talks, and collaborative screenings that challenge conventions and expand the boundaries of moving image work.",
      keyHighlights: [
        "3-day intensive fellowship program",
        "30 total fellows (15 in-person, 15 online)",
        "Access to world premieres and retrospectives",
        "Networking with international film professionals",
        "Artist talks and discussions",
        "Fully funded for selected fellows",
        "Focus on documentary and experimental cinema",
        "Collaborative screening experiences",
      ],
      curriculum: [
        "World premiere screenings",
        "Retrospective programs",
        "Artist conversations and panels",
        "Documentary cinema studies",
        "Experimental media exploration",
        "Collaborative viewing and discussion",
        "Professional networking sessions",
        "Fellowship closing reception",
      ],
      duration: "3 days (October 7–10, 2026)",
      medium: "English",
      courseFee: "Fully funded fellowship (selected participants)",
      certification: "Flaherty Fellowship Certificate",
      contactInfo: [
        "Website: https://flahertyny.org/fellow/",
        "Email: info@flahertyny.org",
      ],
      venue: "New York City (in-person) / Online",
      organizer: "Flaherty Film Seminar",
    },
  },
  {
    id: 86,
    ...
    fullDetails: {
      description:
        "The Inlaks-Attakkalari Dance Studentship 2026 is a fully-funded scholarship opportunity for talented dancers and movement artists seeking professional training in contemporary and classical movement arts with a pedagogical focus. The program is offered by the prestigious Attakkalari Centre for Movement Arts in Bangalore. Candidates interested in this studentship must first clear the audition for the Diploma in Movement Arts and Pedagogy course before submitting their scholarship application.",
      keyHighlights: [
        "Fully-funded scholarship for Diploma program",
        "Training in contemporary and classical movement arts",
        "Focus on movement pedagogy",
        "Professional faculty and mentorship",
        "Year-round full-time program",
        "Based in Bangalore, India",
        "Audition required before application",
      ],
      curriculum: [
      ...
      duration: "Year-round full-time program",
      medium: "English and regional languages",
      courseFee: "Fully funded (scholarship covers all costs)",
      certification: "Diploma in Movement Arts and Pedagogy",
      contactInfo: [
        "Website: https://www.attakkalari.org/",
        "Email: attakkalari@attakkalari.org",
        "Audition Registration: https://forms.gle/QPEE3cuDvETtAZAP8",
        "Application Link: https://docs.google.com/forms/d/e/1FAIpQLSeyTznJM0svRtRhae7-1BVQYUAOTcitjTmPugB18Hf3ucE9tQ/viewform",
      ],
      venue: "Attakkalari Centre for Movement Arts, Bangalore, Karnataka, India",
      organizer: "Attakkalari Centre for Movement Arts",
  ...
  },
  {
    ...
    fullDetails: {
      description:
        "The Weekend Theatre Course at Barry John Acting Studio in Delhi is an introduction to acting and theatre designed with a strong personal-development focus. This part-time course runs on weekends (Saturday and Sunday) from 3:00 PM to 6:00 PM, starting August 8, 2026, and continuing for 3 months. It is structured to accommodate beginners and working professionals who want to explore acting and theatrical techniques while maintaining their weekday commitments.",
      keyHighlights: [
        "Introduction to acting and theatre fundamentals",
        "Strong personal-development focus",
        "Part-time weekend schedule (Sat–Sun)",
        "Designed for beginners and working professionals",
        "Expert BJAS Faculty guidance",
      ...
      duration: "3 months (starting 8 Aug 2026, Saturdays & Sundays)",
      medium: "English",
      courseFee: "Not published — contact for details",
      certification: "Barry John Acting Studio Certificate",
      contactInfo: [
      ...
      venue: "Barry John Acting Studio, Delhi, India",
      organizer: "Barry John Acting Studio",
    },
  },
  {
    ...
    fullDetails: {
      description:
        "Advanced Acting Course (Camera & Theatre) at Five Senses Theatre is an intensive technique-building workshop designed for intermediate to advanced actors. Led by NSD (National School of Drama) and FTII (Film and Television Institute of India) alumni, this comprehensive program runs from July 8 to November 7, 2026, with sessions every evening from 7:00 PM to 10:00 PM. The course provides in-depth training in script analysis, characterization, and scene construction with both stage and camera work, preparing actors for professional roles in theatre and film.",
      keyHighlights: [
        "Advanced technique-building workshop",
        "Expert faculty: NSD & FTII alumni",
        "In-depth script analysis and interpretation",
        "Characterization and scene construction",
        "Both stage and camera work",
        "4-month intensive program",
        "Evening classes (flexible for working professionals)",
        "Professional-level training",
        "Industry-focused approach",
      ],
      curriculum: [
        "Advanced script analysis and interpretation",
        "Character development and psychology",
        "Scene construction and breakdown",
        "Stage acting techniques",
        "On-camera acting and film techniques",
        "Emotional depth and authenticity",
        "Improvisation and spontaneity",
        "Scene work with scene partners",
        "Audition preparation",
        "Professional acting standards",
      ],
      duration: "4 months (8 Jul – 7 Nov 2026, evening classes)",
      medium: "English",
      courseFee: "On application",
      certification: "Five Senses Theatre Certificate",
      contactInfo: [
        "Website: https://fivesensestheatre.com/",
        "Admissions: admissions@fivesensestheatre.com",
        "Registration: https://www.fivesensestheatre.com/admission/",
        "Course Details: https://fivesensestheatre.com/advanced-acting-course/",
      ],
      venue: "Five Senses Theatre, Andheri West, Mumbai, Maharashtra, India",
      organizer: "Five Senses Theatre",
    },
  },
  {
    id: 90,
    ...
    fullDetails: {
      description:
        "Fitzmaurice Voicework® & Vāchikā — 6-Day India Intensive is a transformative workshop led by Mallika Prasad, an NSD alumna and Head of South Asia for the Fitzmaurice Institute. This 6-day intensive (August 11–16, 2026) explores the foundational elements of voice work: breath, resonance, alignment, and release. The program integrates Fitzmaurice Voicework® methodology with text and song, designed for performers, actors, singers, and voice practitioners seeking to deepen their vocal awareness and expressiveness.",
      keyHighlights: [
        "6-day intensive workshop",
        "Expert trainer: Mallika Prasad (NSD alumna, Head of South Asia for Fitzmaurice Institute)",
        "Fitzmaurice Voicework® methodology",
        "Focus on breath, resonance, alignment, and release",
        "Includes text, speech-work, and song",
        "Suitable for all levels",
        "Full-day sessions (10:00 AM – 5:00 PM)",
        "Transformative voice training",
        "Professional-grade instruction",
      ],
      curriculum: [
        "Breath awareness and control",
        "Resonance exploration and development",
        "Alignment and postural awareness",
        "Voice release and freeing techniques",
        "Text analysis and speech work",
        "Song and vocal expression",
        "Emotional authenticity in voice",
        "Professional voice application",
        "Ensemble voice work",
      ],
      duration: "6 days (11–16 Aug 2026, 10:00 AM – 5:00 PM daily)",
      medium: "English",
      courseFee: "Shared upon selection (contact for details)",
      certification: "Vāchikā Voicework & Fitzmaurice Institute Certificate",
      contactInfo: [
        "Organization: Vāchikā Voicework",
        "Trainer: Mallika Prasad",
        "Registration: https://forms.gle/oQfe8xDc4aCXg1jY7",
        "Email: contact@vachika.in",
      ],
      venue: "Andheri West, Mumbai, Maharashtra, India",
      organizer: "Vāchikā Voicework",
    },
  },
  {
    id: 91,
    ...
    fullDetails: {
      description:
        "International Physical Theatre Workshop (Meyerhold / Chekhov / Stanislavski) at NIPAI is a selective 5-day, 28-hour intensive workshop blending three major theatrical methodologies. Led by Sergei & Gennadiy Ostrenko, this workshop is designed for professional and pre-professional performers, directors, and movement practitioners. The intensive covers Meyerhold Biomechanics, Chekhov Psychological Gesture, and Stanislavski Physical Action, offering a comprehensive exploration of physical theatre techniques from different theatrical traditions.",
      keyHighlights: [
        "Selective 5-day, 28-hour intensive",
        "Expert trainers: Sergei & Gennadiy Ostrenko",
        "Three major theatrical methodologies",
        "Meyerhold Biomechanics",
        "Chekhov Psychological Gesture",
        "Stanislavski Physical Action",
        "For professional and pre-professional artists",
        "International program",
        "Early bird pricing available",
        "Selection based on CV",
      ],
      curriculum: [
        "Meyerhold Biomechanics and movement principles",
        "Chekhov Psychological Gesture technique",
        "Stanislavski Physical Action method",
        "Integration of three methodologies",
        "Physical theatre performance",
        "Movement precision and expressivity",
        "Character physicalization",
        "Ensemble movement work",
        "Professional application of techniques",
      ],
      duration: "5 days, 28 hours total (17–21 Aug 2026)",
      medium: "English",
      courseFee: "€350–450 (early bird pricing)",
      certification: "NIPAI Certificate",
      contactInfo: [
        "Organization: NIPAI (New International Performing Arts Institute)",
        "Trainers: Sergei & Gennadiy Ostrenko",
        "Registration: https://www.nipai.org/directing-acting-dance-programs/apply-form-workshops",
        "Email: admissions@nipai.org",
      ],
      venue: "Berlin, Germany",
      organizer: "NIPAI (New International Performing Arts Institute)",
    },
  },
  {
    id: 92,
    ...
    fullDetails: {
      description:
        "Workshop on AI in Cinema at FTII, Pune explores the emerging role of artificial intelligence in filmmaking and visual storytelling. Offered in a hybrid format combining in-person and online sessions (July 13–23, 2026), this workshop is designed for film students, professionals, and enthusiasts interested in understanding and applying AI-based tools to their creative work. Led by FTII faculty, the workshop covers practical applications of AI in various aspects of cinema production.",
      keyHighlights: [
        "Comprehensive AI in cinema workshop",
        "FTII Faculty instruction",
        ...
        "11-day intensive program",
      ],
      curriculum: [
        "AI fundamentals and applications in cinema",
        "AI-based tools for visual effects",
        "Machine learning in filmmaking",
        "AI for scriptwriting and narrative analysis",
        "Automation in post-production",
        "Color grading and AI enhancement",
        "AI for editing and montage",
        "Visual storytelling with AI",
        "Ethics and future of AI in cinema",
        "Case studies from industry",
      ],
      duration: "11 days (13–23 Jul 2026, hybrid format)",
      medium: "English",
      courseFee: "Not published — contact for details",
      certification: "FTII Certificate",
      contactInfo: [
        "Institution: FTII, Pune",
        "Faculty: FTII Faculty",
        "Registration: https://ftii.ac.in/courses",
        "Email: courses@ftii.ac.in",
      ],
      venue: "New Mumbai (in-person component) + Online",
      organizer: "FTII, Pune",
    },
  },
  {
    ...
    fullDetails: {
      description:
        "Foundation Course in Screenplay Writing from FTII, Pune is a comprehensive beginner-level course designed to introduce students to the fundamentals of screenplay writing. Delivered over approximately ten weeks in a flexible weekend and online format (August 1 – October 11, 2026), this course is perfect for those looking to develop their screenwriting skills. Led by FTII faculty, the course covers the essential elements of storytelling, script structure, character development, dialogue writing, and industry-standard formatting.",
      keyHighlights: [
        "Foundation-level screenplay writing course",
        "FTII Faculty instruction",
        "Flexible weekend and online format",
        "10-week program",
        "Industry-standard practices",
        ...
        "For beginners and aspiring screenwriters",
      ],
      curriculum: [
        "Introduction to screenplay fundamentals",
        "Story structure and three-act form",
        "Character development and psychology",
        "Dialogue writing and authenticity",
        "Scene construction and pacing",
        "Industry-standard formatting",
        "Script breakdown and analysis",
        "Genre-specific screenwriting",
        "Adaptation techniques",
        "Script pitching and presentation",
      ],
      duration: "10 weeks (1 Aug – 11 Oct 2026, weekends & online)",
      medium: "English",
      courseFee: "Not published — contact for details",
      certification: "FTII Certificate",
      contactInfo: [
  ...
  },
  {
    ...
    fullDetails: {
      description:
        "The Government of India Ministry of Culture announces the Senior and Junior Fellowship Scheme 2026–27 to support theatre artists, performing artists, academics, and researchers engaged in meaningful cultural work. This fellowship provides monthly financial support for project-based research, creative development, and performance initiatives in theatre and related cultural fields. The scheme recognizes and encourages excellence in theatre practice, artistic innovation, and scholarly contribution to the performing arts.",
      keyHighlights: [
        "Two-tier fellowship program: Junior & Senior",
        "Junior Fellowship: ₹10,000/month (up to 2 years)",
        "Senior Fellowship: ₹20,000/month (up to 2 years)",
        "Project-based support for theatre & performing arts",
        "Support for research, performance, and creative initiatives",
        "Applications open year-round; deadline: 31 July 2026",
        "Government-backed financial support",
        "Flexible project duration and location",
      ],
      curriculum: [
        "Research-oriented theatre projects",
        "Performance-based initiatives",
        "Creative development projects",
        "Academic research in theatre arts",
        "Cultural documentation and preservation",
        "Theatre training and mentorship programs",
        "Cross-cultural artistic collaborations",
        "Community-engaged theatre projects",
      ],
      duration: "Up to 2 years (renewable based on performance)",
      medium: "Hindi / English",
      courseFee: "Fellowship amount: ₹10,000–₹20,000 per month (no application fee)",
      certification: "Government Fellowship Certificate from Ministry of Culture",
      contactInfo: [
        "Ministry of Culture, Government of India",
        "CCRT (Centre for Cultural Resources and Training)",
        "Email: fellowships@culture.gov.in",
        "Application: https://culture.gov.in/files/downloads_document/Application%20Form%20for%20Junior%20Fellowship%20Scheme_16062026.pdf",
        "Deadline: 31 July 2026",
      ],
      venue: "New Delhi (for application submission); Project location flexible",
      organizer: "Ministry of Culture, Government of India",
    },
  },
  {
    id: 95,
    ...
    fullDetails: {
      description:
        "The Scholarship for Young Theatre Artists (SYA) Scheme 2026–27 is a government initiative by the Ministry of Culture to support emerging and talented young theatre professionals. This scheme provides financial assistance of ₹5,000 per month for a duration of 2 years to help young artists advance their careers in theatre. A total of 400 scholarships are available under this scheme. The scholarship is open to Indian nationals who have completed at least 5 years of formal training in theatre disciplines including acting, direction, mime, and other specialized areas of theatre. Applicants must be advanced trainees seeking to further develop their skills and cannot be absolute beginners.",
      keyHighlights: [
        "Monthly scholarship: ₹5,000 per month",
        "Total duration: 2 years",
        "Total scholarships available: 400",
        "Eligible fields: Acting, direction, mime, and other specialized theatre areas",
        "Age eligibility: Born between 1 April 2001 - 31 March 2008",
        "Minimum 5 years training requirement",
        "Indian nationals only",
        "Selection via online interview/performance before expert committee",
        "Offline application submission",
        "Application deadline: 31 July 2026",
      ],
      eligibilityDetails: [
        "Indian nationals only",
        "Age: Born between 1 April 2001 and 31 March 2008",
        "Minimum 5 years of formal training under a Guru or recognized theatre institution",
        "Advanced training seekers only (beginners are not eligible)",
        "Eligible theatre disciplines: Acting, direction, mime, and other specialized areas",
        "Playwriting and research are not eligible under this scheme",
      ],
      applicationProcess: [
        "1. Download the application form from the official link",
        "2. Fill in all required details and attach supporting documents",
        "3. Selected candidates will be invited for online interview/performance",
        "4. Selection will be done by an expert committee",
        "5. Shortlisted candidates will be awarded the scholarship",
      ],
      submissionAddress: {
      ...
      contactInfo: [
        ...
        "Email: sya@culture.gov.in",
        "Application Form: https://culture.gov.in/files/downloads_document/Application_Form_for_SYA_Scheme_2026-27_15062026.pdf",
        "Deadline: 31 July 2026",
      ],
      venue: "New Delhi (CCRT office for submission); Performance/Interview: Online",
      organizer: "Ministry of Culture, Government of India",
    },
  },
  {
    ...
    fullDetails: {
      description:
        "The Senior & Junior Fellowships for Theatre Artists 2026–27 is a government initiative by the Ministry of Culture to support theatre professionals engaged in research-oriented or performance-related projects. This scheme provides significant financial assistance to help artists advance their work in theatre arts. A total of 400 fellowships are available under this scheme: 200 Junior Fellowships for artists aged 25–40 years, and 200 Senior Fellowships for artists aged 40 years and above. The fellowships are designed specifically for academic or performance-related research projects in theatre and are NOT available for training, workshops, seminars, memoirs, autobiographies, or fiction writing.",
      keyHighlights: [
        "Two-tier fellowship program: Junior & Senior",
        "Junior Fellowship: ₹10,000 per month for up to 2 years (200 available)",
        "Senior Fellowship: ₹20,000 per month for up to 2 years (200 available)",
        "For academic or performance-related research projects only",
        "NOT for training, workshops, seminars, memoirs, or fiction",
        "Indian nationals only",
        "Offline application by post",
        "Selection based on project merit and artist credentials",
        "Application deadline: 31 July 2026",
      ],
      eligibilityDetails: [
        "Junior Fellowship: 25–40 years (born between 1 April 1986 and 31 March 2001)",
        "Senior Fellowship: Above 40 years (born on or before 1 April 1986)",
        "Indian nationals only",
        "Demonstrated commitment to theatre arts",
        "Eligible project categories: Academic research in theatre, Performance-related projects, Creative research in performing arts",
        "NOT eligible: Training programs, Workshops, Seminars, Memoirs or autobiographies, Fiction writing",
      ],
      projectRequirements: [
        "1,000–1,500-word project synopsis",
        "Synopsis must be in Hindi or English",
        "Clearly articulate project goals and research methodology",
        "Demonstrate relevance to theatre and cultural development",
        "Show connection to existing body of work or artistic practice",
      ],
      applicationProcess: [
        "1. Download the application form from the official link",
        "2. Fill application form with all required details",
        "3. Prepare 1,000–1,500-word project synopsis (Hindi or English)",
        "4. Attach supporting documents (credentials, portfolio, previous work samples)",
        "5. Send complete application by post to CCRT address",
        "6. Must arrive by 31 July 2026 (postmark deadline)",
      ],
      submissionAddress: {
        address: "Director, Centre for Cultural Resources and Training (CCRT), 15-A, Sector 7, Dwarka, New Delhi – 110075, India",
        envelopeLabel: "Write on envelope: 'Application for Senior/Junior Fellowship Scheme 2026–27'",
      },
      courseFee: "Fellowship amount: ₹10,000–₹20,000 per month for up to 2 years (No application fee)",
      certification: "Government Fellowship Certificate from Ministry of Culture",
      contactInfo: [
        "Ministry of Culture, Government of India",
        "Centre for Cultural Resources and Training (CCRT)",
        ...
        "New Delhi – 110075, India",
        "Email: fellowships@culture.gov.in",
        "Application Form: https://culture.gov.in/files/downloads_document/Application%20Form%20for%20Junior%20Fellowship%20Scheme_16062026.pdf",
        "Deadline: 31 July 2026",
      ],
      venue: "New Delhi (CCRT office for submission); Project location flexible based on research needs",
      organizer: "Ministry of Culture, Government of India",
    },
  },
]
