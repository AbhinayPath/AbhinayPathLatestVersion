...
const workshops: Workshop[] = [
  ...
  },
  {
    ...
    fullDetails: {
      description:
        "The Natya-Shastra Workshop: Basics of Acting is a week-long intensive program offered by the Film and Television Institute of India (FTII) – Centre for Open Learning. This workshop explores performance techniques inspired by the ancient Natya-Shastra, the foundational treatise on Indian performing arts. Participants will learn the fundamentals of acting, including expression (abhinaya), character work, emotional recall, and stage performance through structured training sessions led by experienced FTII faculty. The workshop bridges classical Indian theatrical traditions with contemporary performance techniques.",
      keyHighlights: [
        "7-day intensive acting workshop (12–18 April 2026)",
        "Performance techniques inspired by Natya-Shastra",
        "Fundamentals of acting and expression (abhinaya)",
        "Character development and emotional work",
        "Stage performance and presentation skills",
        "Training by experienced FTII Faculty",
        "FTII Certificate upon completion",
        "Application deadline: 2 March 2026 (6 PM)",
      ],
      curriculum: [
        "Introduction to Natya-Shastra principles",
        "Fundamentals of acting and performance",
        "Abhinaya (expression) techniques",
        "Character analysis and development",
        "Emotional recall and memory exercises",
        "Voice and body coordination",
        "Stage presence and movement",
        "Scene work and performance practice",
      ],
      duration: "7 days (12–18 April 2026)",
      medium: "Hindi / English",
      courseFee: "Contact FTII for fees (Apply via SBI Collect form)",
      certification: "FTII Certificate of Completion",
      contactInfo: [
        "Phone: 020-25580085",
        "Email: info.cfol@ftii.ac.in",
      ...
      venue: "Mumbai, India",
      organizer: "Film and Television Institute of India (FTII) – Centre for Open Learning",
    },
  },
]
