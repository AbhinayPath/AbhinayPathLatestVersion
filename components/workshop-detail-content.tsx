...
const workshops: Workshop[] = [
  ...
  },
  {
    ...
    description:
      "Mobility grant supporting artists and cultural professionals across Europe with funding for cross-border collaborations, residencies, and professional development.",
    ...
    fullDetails: {
      description:
        "Culture Moves Europe is a groundbreaking mobility grant programme supporting artists and cultural professionals across Europe. With rolling monthly deadlines throughout 2026, this initiative provides funding for cross-border collaborations, artistic residencies, networking opportunities, and professional development projects. The programme aims to strengthen European cultural cooperation and facilitate artistic exchange across borders.",
      keyHighlights: [
        "Rolling monthly application deadlines (Jan 31, Feb 28, Mar 31, Apr 30, 2026)",
        "Mobility grants for European artists and cultural professionals",
        "Support for cross-border collaborations and residencies",
        "Professional development opportunities across Europe",
        "Strengthening European cultural networks",
      ],
      curriculum: [
        "Individual mobility grants for artistic projects",
        "Cross-border collaboration funding",
        "Residency programme support",
        "Professional development opportunities",
        "Networking and cultural exchange activities",
      ],
      duration: "Varies by project (rolling deadlines throughout 2026)",
      medium: "Multiple languages (English as working language)",
      courseFee: "Grant funding provided (no fee)",
      certification: "Programme participation recognition",
      contactInfo: [
        "Website: https://on-the-move.org/news/countries",
        "Deadlines: 31 Jan, 28 Feb, 31 Mar, 30 Apr 2026",
