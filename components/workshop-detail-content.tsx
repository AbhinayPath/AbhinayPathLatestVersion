...
const workshops = [
  ...
  },
  {
    ...
    fullDetails: {
      ...
      learningOutcomes: [
        "Understanding contemporary youth experiences in digital spaces",
  ...
  },
  {
    ...
    fullDetails: {
      description:
        "The ITI Academy Week takes place during THEATER DER WELT, one of the world's most important theatre festivals. This intensive one-week programme brings together theatre makers from around the globe for workshops, performances, discussions, and networking. Participants will engage with contemporary theatre practices, meet leading international artists, and experience the festival's diverse programme. The fellowship covers all costs including accommodation, meals, and festival tickets.",
      venue: "Berlin and Chemnitz, Germany",
      ...
      courseFee: "Fully covered by fellowship",
      certification: "Certificate of participation",
      keyHighlights: [
        "Participation in THEATER DER WELT festival",
        "Full festival access and performances",
      ...
      curriculum: [
        ...
        "Networking events",
        "Behind-the-scenes festival experiences",
        "Cultural excursions in Berlin and Chemnitz",
        "Collaborative projects with fellow participants",
      ],
      targetAudience: [
        "Theatre directors and makers",
        "Actors and performers",
        "Dramaturgs and playwrights",
        "Theatre educators",
        "Emerging theatre artists",
        "Theatre students (advanced level)",
        "International theatre professionals",
      ],
      learningOutcomes: [
        "Understanding of contemporary global theatre",
        "International professional theatre network",
        "Exposure to diverse performance practices",
        "Critical analysis of contemporary work",
        "Collaborative and intercultural skills",
        "Knowledge of European theatre landscape",
        "Career development opportunities",
      ],
    },
  },
  ...
  },
  {
    ...
    fullDetails: {
      ...
      practicalDetails: [
        ...
        "🏠 Food & Accommodation: Not included (arrange separately)",
  ...
  },
  {
    ...
    fullDetails: {
      description:
        "A unique puppetry workshop guided by a distinguished panel of master puppeteers, educationalists, and artists. This intensive 5-day workshop is organised by Indian Institute of Educational Theatre (IIET) in collaboration with Astikya Foundation and supported by Rajiv Gandhi Foundation. Participants will learn various puppetry techniques from experienced practitioners in the field, gaining hands-on experience in this traditional art form.",
      venue: "Indian Institute of Educational Theatre (IIET), Hardwick School Campus, J.L.B. Road, Mysuru",
      organizer:
        "Indian Institute of Educational Theatre (IIET) in collaboration with Astikya Foundation, Supported by Rajiv Gandhi Foundation",
      duration: "5 days (16th to 20th December 2025)",
      medium: "English, Kannada & Hindi",
      eligibilityCriteria: [
        "Open to all age groups",
        "Students interested in puppetry",
        "Theatre practitioners",
        "Art educators",
        "Anyone passionate about puppetry and visual storytelling",
      ],
      applicationDeadline: "Contact for availability",
      courseBegins: "16th December 2025",
      selectionProcess: "First-come, first-served basis",
      capacity: "Limited seats available",
      courseFee: "₹3,000 for Students & Theatre Practitioners, ₹5,000 for Others",
      certification: "Certificate of Participation from IIET",
      keyHighlights: [
        "Learn from master puppeteers with decades of experience",
        "Hands-on training in various puppetry techniques",
        "Guidance from distinguished panel including Umashanker Periodi, Shashidara Adapa, Prasanna, and Gagan",
        "Supported by Rajiv Gandhi Foundation",
        "Collaboration with Astikya Foundation",
        "Immersive 5-day intensive workshop",
        "Exposure to traditional and contemporary puppetry forms",
        "Certificate upon completion",
      ],
      curriculum: [
        "Introduction to various puppetry forms",
        "String puppet (Marionette) techniques",
        "Hand puppet creation and manipulation",
        "Shadow puppetry basics",
        "Rod puppet techniques",
        "Puppet making and construction",
        "Voice modulation for puppet characters",
        "Storytelling through puppetry",
        "Performance techniques and staging",
        "Integration of puppetry in educational theatre",
      ],
      courseStructure: [
        "Day 1: Introduction to Puppetry - History, forms, and fundamentals",
        "Day 2: Puppet Making Workshop - Creating your own puppet",
        "Day 3: Manipulation Techniques - Bringing puppets to life",
        "Day 4: Voice and Character Development - Creating puppet personalities",
        "Day 5: Performance and Presentation - Showcase of learned skills",
      ],
      learningOutcomes: [
        "Understanding of different puppetry traditions and forms",
        "Ability to create basic puppets",
        "Skills in puppet manipulation and control",
        "Voice modulation techniques for puppet characters",
        "Storytelling skills through puppetry",
        "Integration of puppetry in educational and theatrical contexts",
        "Appreciation of puppetry as an art form",
      ],
      aboutInstructor:
        "The workshop is led by a distinguished panel of master puppeteers and experienced practitioners:\n\n• Umashanker Periodi - Renowned puppeteer with extensive experience in traditional puppetry forms\n• Shashidara Adapa - Expert in puppet making and educational theatre\n• Prasanna - Experienced practitioner in contemporary puppetry\n• Gagan - Specialist in puppet manipulation and performance\n\nAlong with contributions from several other experienced practitioners in the field of puppetry and educational theatre.",
      whyChooseThisWorkshop: [
        "Learn from master puppeteers with decades of experience",
        "Organised by IIET - a premier institution for educational theatre",
        "Supported by Rajiv Gandhi Foundation",
        "Affordable fee structure for students and theatre practitioners",
        "Hands-on practical training",
        "Beautiful location in Mysuru",
        "Certificate from a recognized institution",
        "Networking with fellow puppetry enthusiasts",
      ],
      targetAudience: [
        "Theatre practitioners seeking to add puppetry to their skills",
        "Students interested in visual storytelling",
        "Art educators and teachers",
        "Cultural enthusiasts",
        "Anyone passionate about puppetry",
        "Performers looking to explore new mediums",
      ],
      contactInfo: [
        "Phone & WhatsApp: 9448871815",
        "Venue: IIET, Hardwick School Campus, J.L.B. Road, Mysuru",
        "Registration: Contact via WhatsApp",
      ],
      additionalInfo:
        "This workshop is part of the Puppetry Festival Mysore, bringing together master puppeteers and enthusiasts to celebrate and learn this ancient art form. The collaboration between IIET, Astikya Foundation, and the support from Rajiv Gandhi Foundation ensures a high-quality learning experience. Participants will not only learn puppetry techniques but also understand the cultural significance and educational applications of this versatile art form.",
    },
  },
]
          ...
          >
            <Image
              ...
              onError={(e) => {
                ...
                target.src = "/placeholder.svg?height=400&width=600&text=Workshop+Image"
              }}
            />
          </div>
          <div
