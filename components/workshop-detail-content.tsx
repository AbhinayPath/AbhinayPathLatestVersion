...
const workshops: Workshop[] = [
  ...
  },
  {
    ...
    fullDetails: {
      ...
      curriculum: [
        "Academic or performance-related research projects in theatre",
        "Research methodology and project documentation",
        "Performance creation or artistic research initiatives",
        "Theatre history, theory, or cultural studies research",
        "Creative performance projects with research component",
        "Project synopsis preparation (1,000–1,500 words)",
        "Portfolio and credential documentation",
      ],
      duration: "Up to 2 years (renewable based on project progress)",
      medium: "Hindi / English",
