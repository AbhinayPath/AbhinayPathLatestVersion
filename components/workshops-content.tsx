...
const workshops = [
  {
    ...
    trainer: "Umashanker Periodi, Shashidara Adapa, Prasanna, Gagan & other master puppeteers",
    ...
    time: "10 AM to 4 PM",
    description:
      "🎭 Learn the art of puppetry from master puppeteers at IIET Mysore! This workshop is guided by a distinguished panel including Umashanker Periodi, Shashidara Adapa, Prasanna, Gagan, and other experienced practitioners. Organized by IIET in collaboration with Astikya Foundation and supported by Rajiv Gandhi Foundation.",
    ...
    contact: "9448871815 (Phone & WhatsApp)",
    email: "Via WhatsApp",
    eligibility: "Open to all – Students, Theatre Practitioners & General Public",
    mode: "Offline",
    ...
    includes: "Puppetry training from master puppeteers + Hands-on workshop experience",
    highlights: [
      "Master Puppeteers as Trainers",
      "Hands-on Puppetry Training",
      "5-Day Intensive Workshop",
      "IIET Campus, Mysuru",
      "Collaboration with Astikya Foundation",
      "Supported by Rajiv Gandhi Foundation",
    ],
    collaborators: "Astikya Foundation",
    supporters: "Rajiv Gandhi Foundation",
  },
  {
    id: 33,
