...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://www.abhinaypath.com/city/${citySlug}/theatre-workshops`,
    ...
    alternates: {
      canonical: `https://www.abhinaypath.com/city/${citySlug}/theatre-workshops`,
    },
  }
}
...
export default async function CityWorkshopsPage({ params }: PageProps) {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Theatre Workshops", url: `https://www.abhinaypath.com/city/${citySlug}/theatre-workshops` },
  ])
              ...
              <div className="flex flex-wrap gap-3">
                {otherCities.map((otherCity) => (
                  <Button key={otherCity.slug} variant="outline" size="sm" asChild>
                    <Link href={`/city/${otherCity.slug}/theatre-workshops`}>
                      {otherCity.name}
                    </Link>
                  </Button>
                ))}
